...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Summarize Bench2Drive route JSON files")
    parser.add_argument("route_dir", help="directory containing route result JSON files")
