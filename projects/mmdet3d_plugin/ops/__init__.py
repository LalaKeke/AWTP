...
from .deformable_aggregation_a800 import (
    DeformableAggregationFunctionA800,
...
def deformable_aggregation_function(
    ...
    if device_name == 'NVIDIA A800 80GB PCIe' and deformable_aggregation_ext_a800 is not None:
